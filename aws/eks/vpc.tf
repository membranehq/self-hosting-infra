...
resource "aws_eip" "nat" {
  ...
  tags = {
    Name      = "${var.environment}-${var.project}-nat-${var.availability_zones[count.index]}"
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name      = "${var.environment}-${var.project}-private-rt-${var.availability_zones[count.index]}"
    Component = "vpc-routing"
  }
}
