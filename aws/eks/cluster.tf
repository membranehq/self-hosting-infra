...
resource "aws_iam_role" "node_group" {
  name = "${var.environment}-${var.project}-node-group-role"
...
resource "aws_security_group" "node_group" {
  name        = "${var.environment}-${var.project}-node-group-sg"
  ...
  tags = {
    Name                                            = "${var.environment}-${var.project}-node-group-sg"
    Service                                         = "eks"
    "kubernetes.io/cluster/${var.environment}-${var.project}-cluster" = "owned"
  }
}
