...
resource "azurerm_cdn_frontdoor_origin" "api" {
  ...
  enabled                        = true
  host_name                      = "${var.environment}-${var.project}-api-ca.${azurerm_container_app_environment.main.default_domain}"
  http_port                      = 80
  https_port                     = 443
  origin_host_header             = "${var.environment}-${var.project}-api-ca.${azurerm_container_app_environment.main.default_domain}"
  priority                       = 1
  weight                         = 1000
  certificate_name_check_enabled = true
}
...
resource "azurerm_cdn_frontdoor_origin" "ui" {
  ...
  enabled                        = true
  host_name                      = "${var.environment}-${var.project}-ui-ca.${azurerm_container_app_environment.main.default_domain}"
  http_port                      = 80
  https_port                     = 443
  origin_host_header             = "${var.environment}-${var.project}-ui-ca.${azurerm_container_app_environment.main.default_domain}"
  priority                       = 1
  weight                         = 1000
  certificate_name_check_enabled = true
}
...
resource "azurerm_cdn_frontdoor_origin" "console" {
  ...
  enabled                        = true
  host_name                      = "${var.environment}-${var.project}-console-ca.${azurerm_container_app_environment.main.default_domain}"
  http_port                      = 80
  https_port                     = 443
  origin_host_header             = "${var.environment}-${var.project}-console-ca.${azurerm_container_app_environment.main.default_domain}"
  priority                       = 1
  weight                         = 1000
  certificate_name_check_enabled = true
}
